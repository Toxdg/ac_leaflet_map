...
//
function ac_poimaps_leaflet_media_poi_js(){
    $plugins_url = plugins_url();
    wp_enqueue_media();
    wp_register_script('ac_poimaps_leaflet_media', plugin_dir_url(__FILE__) . 'js/media.js', array(
        'jquery',
    ));
    wp_enqueue_script('ac_mediac_poimaps_leaflet_mediaa_poi');
}
add_action('admin_enqueue_scripts', 'ac_poimaps_leaflet_media_poi_js');
    ...
    <table class="form-table poi-settings">
    	<tr valign="top">
         ...
         <tr valign="top">
            ...
            <td><input type="checkbox" name="ac_leaflet_category" value="1"<?php if (get_option('ac_leaflet_category') == 1) {
                                                                                echo 'checked';
                                                                            } ?>><?php if (get_option('ac_leaflet_category') == 1) {
                                                                                    echo 'on';
                                                                                } else {
                                                                                    echo 'off';
                                                                                } ?></td>
       ...
       <tr valign="top">
            ...
            <td><input type="checkbox" name="ac_leaflet_wojewodztwa" value="1"<?php if (get_option('ac_leaflet_wojewodztwa') == 1) {
                                                                                    echo 'checked';
                                                                                } ?>><?php if (get_option('ac_leaflet_wojewodztwa') == 1) {
                                                                                        echo 'on';
                                                                                    } else {
                                                                                        echo 'off';
                                                                                    } ?></td>
        ...
        <tr valign="top">
            ...
            <td><input type="checkbox" name="ac_leaflet_mcluster" value="1"<?php if (get_option('ac_leaflet_mcluster') == 1) {
                                                                                echo 'checked';
                                                                            } ?>><?php if (get_option('ac_leaflet_mcluster') == 1) {
                                                                                    echo 'on';
                                                                                } else {
                                                                                    echo 'off';
                                                                                } ?></td>
        ...
        <tr valign="top">
            ...
            <td><input type="checkbox" name="ac_leaflet_poi_list" value="1"<?php if (get_option('ac_leaflet_poi_list') == 1) {
                                                                                echo 'checked';
                                                                            } ?>><?php if (get_option('ac_leaflet_poi_list') == 1) {
                                                                                    echo 'on';
                                                                                } else {
                                                                                    echo 'off';
                                                                                } ?></td>
        ...
        <tr valign="top">
            ...
            <td><input type="checkbox" name="ac_leaflet_filtr" value="1"<?php if (get_option('ac_leaflet_filtr') == 1) {
                                                                            echo 'checked';
                                                                        } ?>><?php if (get_option('ac_leaflet_filtr') == 1) {
                                                                                echo 'on';
                                                                            } else {
                                                                                echo 'off';
                                                                            } ?></td>
        ...
        <tr valign="top">
            <th scope="row"></th>
            <td><h2><?php echo __('Map Center', poimaps_leaflet_cfg()->textdomain); ?></h2> <a href="http://web4you.com.pl/11.html" target="_blank"><?php echo __('check', poimaps_leaflet_cfg()->textdomain); ?></a></td>
        </tr> 
        <tr valign="top">
            <th scope="row">latFld</th>
            <td><input type="text" name="ac_leaflet_latFld" value="<?php if (get_option('ac_leaflet_latFld') == '') {
                                                                        echo '52.173931692568';
                                                                    } else {
                                                                        echo get_option('ac_leaflet_latFld');
                                                                    } ?>"></td>
        </tr>
        <tr valign="top">
            <th scope="row">lngFld</th>
            <td><input type="text" name="ac_leaflet_lngFld" value="<?php if (get_option('ac_leaflet_lngFld') == '') {
                                                                        echo '18.8525390625';
                                                                    } else {
                                                                        echo get_option('ac_leaflet_lngFld');
                                                                    } ?>"></td>
        </tr>  
        <tr valign="top">
            <th scope="row"></th>
...
function ac_leaflet_get_style_label($style = null){
    if (is_null($style)) {
        $style = get_option('ac_leaflet_style');
    }
    $def_styles = array(
        'Topographic' => '',
        'Streets' => '',
